 ...
 */
public final class DizzyLogin {
    private static var currentLoginProvider: Provider?
     ...
     */
    public static func login(_ loginProvider: Provider, callback: @escaping ExternalLoginCallback) {
