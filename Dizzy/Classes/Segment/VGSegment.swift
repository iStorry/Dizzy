...
// MARK: - public
public extension VGSegment {

    func selectionTitle(index: Int, animated: Bool = true) {
...
public extension VGSegment {
    ...
    func labelSizeToFit(_ text: String, font: UIFont) -> CGFloat {
        ...
        let width = titleText.boundingRect(with: CGSize(width: CGFloat(MAXFLOAT), height: 0.0),
